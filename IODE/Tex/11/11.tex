...
\pagestyle{fancy}
\renewcommand{\theUnit}{3.1}
\ifthenelse{\isundefined{\UnitPageNumbers}}{}{\setcounter{page}{1}}
\rhead{Section \theUnit: Introduction to Systems of ODE's}
...
%\item \includegraphics{11/11fig1} A crop duster plane with a two blade propeller is rolling along a runway. On the end of one of the propeller blades, which are rotating clockwise at a slow constant speed, is a noticeable red paint mark. Imagine that for the first several rotations of the propeller blades the red mark leaves a ``trace'' in the air as the plane makes its way down the runway.  \label{09problem3}
...
%\begin{tikzpicture}
%\node at (4,6) {\includegraphics[]{11/11fig2}};
...
%\node at (5,4) {\includegraphics[width=2in]{11/11fig3}}; 
%\node at (12,4) {\includegraphics[]{11/11fig2}};
...
%\node at (1,2) {\includegraphics[]{11/11fig2}};
...
%\node at (4,0.5) {\includegraphics[]{11/11fig2}};
...
%\bi
%\ii Submit an electronic version of your solutions by uploading a file containing all of your work in Canvas.
%\ii You will be graded more on HOW you solve problems rather than just your final answer. Be sure to neatly organize and show all of the work you did to derive your final answers. Answers with incomplete or insufficient work or explanations will not earn full credit.
%\ii  Do NOT write work in the margins of this document. Write your work out neatly and legibly on a separate document. Points may be deducted for work that is difficult to read or follow.
...
%\ei
%\ii Thanks for your cooperation and have fun!
%\ei
...
\begin{enumerate*}
\item \includegraphics[width=3in]{11/11HWVectorFieldMatchA.png}
\item \includegraphics[width=3in]{11/11HWVectorFieldMatchB.png}
\item \includegraphics[width=3in]{11/11HWVectorFieldMatchC.png}
\end{enumerate*}
\begin{center}
\begin{enumerate*}
\item[(i)]
...
\begin{enumerate*}
\item \includegraphics[width=3in]{11/11HWPhasePlaneSolution1.png} \label{09HWproblem7parta}
\item \includegraphics[width=3in]{11/11HWPhasePlaneSolution2.png} \label{09HWproblem7partb}
\item \includegraphics[width=3in]{11/11HWPhasePlaneSolution3.png} \label{09HWproblem7partc}
\item \includegraphics[width=3in]{11/11HWPhasePlaneSolution4.png} \label{09HWproblem7partd}
\end{enumerate*}
\end{enumerate}
'
